...
public class PathFinding : MonoBehaviour
{
    ...
    public void Setup(int width, int height, float cellSize)
    {
        ...
        gridSystem = new GridSystem<PathNode>(widht, height, cellSize, (GridSystem<PathNode> g, GridPosition gridPosition) => new PathNode(gridPosition));
